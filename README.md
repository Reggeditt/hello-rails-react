...
**[Hello Rails React]** is an app with a rails backend with a react frontent in the same repo.
...
- **[Shows random greeting from the database]**
...
```
git clone https://github.com/Reggeditt/hello-rails-react.git
```
### Install
